...
def main():
    ...
    print(
        f"{TermColors.HEADER}Welcome to the Language Learning Helper!{TermColors.ENDC}"
    )
    ...
    while True:
        ...
        choice = input(
            f"{TermColors.BOLD}Please choose a mode (1-4): {TermColors.ENDC}"
        )
        ...
        if choice == "1":
            ...
            print(
                f"{TermColors.FAIL}Invalid choice. Please enter a number between 1 and 4.{TermColors.ENDC}"
            )
